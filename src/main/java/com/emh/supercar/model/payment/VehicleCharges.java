...
import com.emh.supercar.model.vehicle.CarType;
...
public class VehicleCharges {
	...
	public VehicleCharges(int vehiclechargeid, CarType cartype, double h_c_p_day, double h_c_p_night,
			double c_p_day, double c_p_night, double c_p_week, double c_p_month, double extra_c_p_km,
			double wait_c_p_min) {
		super();
